...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(this.environment.getProperty("api.sales.actuator.url.path")).permitAll()
		.antMatchers(this.environment.getProperty("api.products.actuator.url.path")).permitAll()
		.antMatchers(this.environment.getProperty("api.orders.actuator.url.path")).permitAll()
		.antMatchers(this.environment.getProperty("api.eureka.actuator.url.path")).permitAll()
		.antMatchers(this.environment.getProperty("api.customers.actuator.url.path")).permitAll()
		.antMatchers(this.environment.getProperty("api.configuration.actuator.url.path")).permitAll()
		.antMatchers(this.environment.getProperty("api.categories.actuator.url.path")).permitAll()
		.antMatchers(this.environment.getProperty("api.authentication.actuator.url.path")).permitAll()
